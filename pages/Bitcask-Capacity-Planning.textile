...
<li>Average Record Size (Bytes): <input id="n_record_size"type="text" size="7" name="n_record_size" value="" class="calc_input"><span class="error_span"id="n_record_size_error"></span></li>
...
<li><i>N</i> (Number of Write Copies): <input type="text" size="2" name="n_nval" id="n_nval" value="" class="calc_input"><span class="error_span" id="nval_error"></span></li>
...
<li>Average Record Size: <input type="text" size="8" name="value_size" id="value_size" value="" class="calc_input"><span class="error_span" id="value_size_error"></span></li>
...
<li><b>Total Disk Space:</b> <span id="total_disk_space"></span></li>
</div>
