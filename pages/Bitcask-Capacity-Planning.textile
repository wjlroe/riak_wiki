...
<li>&nbsp;</li>
<li>Node Count: <span id="node_count"></span></li>
</ul>
...
<li>&nbsp;</li>
<li>Key Overhead: <span id="key_overhead"></span></li>
<li>Total Documents: <span id="total_documents"></span></li>
<li>Total Disk Space: <span id="total_disk_space"></span></li>
</div>
