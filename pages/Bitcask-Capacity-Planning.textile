...
Total Number of Keys: <input type="text" size="12" name="n_total_keys" id="n_total_keys" value=""><span class="error_span" id="n_total_keys_error"></span>
Average Record Size (Bytes): <input type="text" size="7" name="n_record_size" id="n_record_size" value=""><span class="error_span"id="n_record_size_error"></span>
